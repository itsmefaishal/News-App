...
class News extends Component {
    ...
    render(){
        return(
            ...
            <h2>Daily News for you - MB Softech</h2>   
            
                <div className="row">
                {this.state.news.map((element)=>{
                    return(
                        <div key={element.id} className="col-md-3 my-2">
                        <NewsItem id={element.id} title={element.title.slice(0,55)+'...'} 
